module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'importer',
      explanation:
        'Skriv her din mnemonic, private nøkkel, WIF, eller hva som helst annet. AcmLNWallet vil gjøre sitt beste for å gjette riktig format og importere lommeboken din',
      imported: 'importert',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      ' og legg URLen her i innstillinger. La feltet være tomt for å bruke AcmLNWallets LNDHub (lndhub.io). Lommebøker opprettet etter lagring av endringer, vil koble til den angitte LNDHub.',
    save: 'Lagre',
    about: 'Om',
    language: 'Språk',
    currency: 'Valuta',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'passord. For å holde mynten din trygg, kan AcmLNWallet opprette en annen' +
      'kryptert lagring, med et annet passord. Under press,' +
      'Du kan oppgi dette passordet til en tredjepart. Hvis inntastet i' +
      'AcmLNWallet, det vil låse opp ny "falsk" lagring. Dette vil virke' +
