module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'içeri yükle',
      explanation:
        'Buraya cüzdan yedek cümlenizi, gizli anahtarınızı, WIF veya diğer bilginizi yazın. AcmLNWallet elinden gelen en iyi tahmini yaparak cüzdanınızı içeri aktarmaya çalışacak.',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      " ve URL’sini buraya, ayarlara yazın. AcmLNWallet'in LNDHub (lndhub.io) programını kullanmak için boş bırakın. Değişiklikleri kaydettikten sonra oluşturulan cüzdanlar belirtilen LNDHub'a bağlanacaktır.",
    save: 'Kaydet',
    about: 'Hakkında',
    language: 'Dil',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Paralarınızı güvende tutmak için, AcmLNWallet başka bir şifre ile ' +
      'şifreli depolama alanı yaratabilir. Baskı altında, ' +
      'Bu şifreyi 3. bir tarafa söyleyebilirsiniz. Girilirse ' +
      "AcmLNWallet, yeni 'sahte' bir depolamanın kilidini açacaktır. Bu 3. şahıslara " +
