module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'tuo',
      explanation:
        'Kirjoita tähän muistisanasi, private key, WIF tai jotain mitä sinulla on. AcmLNWallet tekee parhaansa arvatakseen oikean muodon ja tuo lompakkosi',
      imported: 'Tuotu',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      ' ja laita sen URL tänne. Jätä tyhjäksi käyttääksesi AcmLNWalletin LNDHubia (lndhub.io). Muutosten tallentamisen jälkeen luodut lompakot yhdistävät annettuun LNDHubiin.',
    save: 'Tallenna',
    about: 'Tietoa',
    language: 'Kieli',
    currency: 'Valuutta',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'salasanasi. Pitääksesi kolikkosi turvassa, AcmLNWallet voi luoda toisen ' +
      'salatun tallennustilan, toisella salasanalla. Paineen alla, ' +
      'voit kertoa tämän salasanan kolmannelle osapuolelle. Annettaessa ' +
      'AcmLNWalletiin, se avaa uuden väärennetyn tallennustilan. Se näyttää ' +
