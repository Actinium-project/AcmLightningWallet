module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Импорт',
      explanation: 'Напиши тут свою мнемоническую фразу, приватный ключ, WIF - что угодно! AcmLNWallet постарается угадать верный формат',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'Чтобы сохранить свой Bitcoin в безопасности, AcmLNWallet может создать ' +
      ...
      "AcmLNWallet, разблокируется 'фальшивое' хранилище. Это будет выглядеть " +
