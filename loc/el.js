module.exports = {
  ...
  wallets: {
    ...
    import: {
      title: 'Εισαγωγή',
      explanation:
        'Γράψε εδώ το μνημονικό (φράση), το ιδιωτικό κλειδί, το WIF, ή ό,τι άλλο έχεις. Το AcmLNWallet θα προσπαθήσει να μαντέψει το σωστό format και να εισάγει το πορτοφόλι',
      imported: 'Εισήχθη',
  ...
  settings: {
    ...
    lightning_settings_explain:
      ...
      ' και βάλτε το URL του εδώ. Αφήστε το κενό για να χρησιμοποιήσετε το LNDHub της AcmLNWallet (lndhub.io). Αφού σώσετε τις ρυθμίσεις τυχόν νέα πορτοφόλια που θα δημιουργήσετε θα συνδεθούν στο LNDHub που επιλέξατε.',
    save: 'Σώσε',
    about: 'Σχετικά',
    language: 'Γλώσσα',
    currency: 'Νόμισμα',
  ...
  plausibledeniability: {
    ...
    help:
      ...
      'κωδικό σας. Για να προστατέψετε τα χρήματά σας, το AcmLNWallet μπορεί να δημιουργήσει ένα εναλλακτικό ' +
      ...
      'βάλει στο AcmLNWallet θα δει ένα μόνο ένα ψεύτικο αρχείο που μοιάζει ' +
